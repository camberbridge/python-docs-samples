...
Usage Examples:
    - label detection
        ...
        - python analyze.py labels resources/cat.mp4
    - scene separation
        - python analyze.py shots gs://demomaker/gbikes_dinosaur.mp4
        - python analyze.py shots resources/cat.mp4
    - evaluation content
        - python analyze.py explicit_content gs://demomaker/gbikes_dinosaur.mp4
        - python analyze.py explicit_content resources/cat.mp4
"""
...
def analyze_explicit_content(path):
    ...
    analyze_explicit_content_main(operation)


def analyze_explicit_content_main(operation):
...
def analyze_labels(path):
    ...
    if path.find('gs://') > -1:
        ...
        operation = video_client.annotate_video(
            features=features, input_content=input_content)
    analyze_labels_main(operation)


def analyze_labels_main(operation):
...
def analyze_shots(path):
    ...
    if path.find('gs://') > -1:
        ...
        operation = video_client.annotate_video(
            features=features, input_content=input_content)
    analyze_shots_main(operation)


def analyze_shots_main(operation):
